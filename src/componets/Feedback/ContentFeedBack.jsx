...
const ContentFeedback = () => {
  ...
  return (
    <section className="bg-gradient-to-r from-gray-950 via-purple-950/40 to-gray-950 text-white py-20 relative overflow-hidden">
      {/* Decorative elements */}
      ...
      <div className="container mx-auto max-w-7xl px-6 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-5xl md:text-6xl font-serif font-bold mb-4 bg-gradient-to-r from-white via-amber-100 to-white bg-clip-text text-transparent">
            Your Voice Matters
          </h2>
          ...
          <div className="flex items-center justify-center gap-8 mt-8">
            <div className="text-center">
              <div className="text-3xl font-bold text-amber-500">1,248</div>
          ...
          <div>
            ...
            <div className="rounded-2xl bg-white/5 ring-1 ring-white/10 p-6">
              <div className="flex items-center gap-3">
                ...
                <div className="text-white/70 text-sm">(1,248 reviews)</div>
              </div>
              ...
              <div className="mt-6 space-y-6">
                {testimonials.map((t) => (
                  ...
                  >
                    ...
                    <div className="mt-2 text-white/60 text-sm">— {t.name}</div>
                  </div>
                ))}
              </div>
            </div>
            ...
            >
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <input
                  ...
                  className="rounded-md bg-white/10 text-white placeholder-white/50 border border-white/20 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-amber-500/40"
                />
                <input
                  name="email"
                  type="email"
              ...
              <div className="mt-4">
                <textarea
                  ...
                  rows={5}
                  className="w-full rounded-md bg-white/10 text-white placeholder-white/50 border border-white/20 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-amber-500/40 resize-none"
                />
              </div>
              ...
              {submitted && (
                <div className="mt-6 p-4 bg-green-500/20 border border-green-500/50 rounded-lg text-green-300 text-sm flex items-center gap-2">
                  <svg
                    className="w-5 h-5"
                    fill="currentColor"
                    viewBox="0 0 20 20"
