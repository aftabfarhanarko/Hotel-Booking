...
const Footer = () => {
  return (
    <footer className="bg-slate-900 text-white">
      <div className=" max-w-10/12 mx-auto px-6  md:px-0 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div>
            <h4 className="text-sm tracking-[0.35em] uppercase text-amber-500">
              Explore
            </h4>
            <ul className="mt-4 space-y-3">
              ...
              <li>
                <Link href="/dining" className="text-white/80 hover:text-white">
                  Dining
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/offers" className="text-white/80 hover:text-white">
                  Offers
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <div className="mt-4 space-y-3 text-white/80">
              <div className="flex items-center gap-2">
                <Phone size={18} className="text-amber-500" /> +1 (888) 123-4567
              </div>
              <div className="flex items-center gap-2">
              ...
              <div className="flex items-start gap-2">
                <MapPin size={18} className="text-amber-500" /> 12 Regent
                Avenue, City Center
              </div>
            </div>
          </div>
